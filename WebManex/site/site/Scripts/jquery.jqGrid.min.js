...
jQuery.extend($.fn.fmatter, {
    rmaCheck: function (cellvalue, options, rowdata) {
...
jQuery.extend($.fn.fmatter, {
    imageBool: function (cellvalue, options, rowdata) {
        var type = "ui-icon-check";

        if (options.colModel.formatoptions != null)
        { type = options.colModel.formatoptions.img; }

        if (cellvalue == "True")
        { return '<center><span class="ui-icon ' + type + '"/></center>'; }
        else
        { return ''; }
    }
});